...
export default function Header() {
  ...
  return (
    <motion.header
      ...
      className="sticky inset-x-0 top-0 z-[1000] -mb-[15.38vw] flex h-[15.38vw] items-center [--nav-menu-y:4vw] md:-mb-[clamp(45px,3.57vw,200px)] md:h-[clamp(45px,3.57vw,200px)] md:[--nav-menu-y:1vw]"
    >
      <div className="flex w-full items-center justify-between pl-6 pr-4">
        ...
        <div className="z-[99999999999999]">
          <motion.div
            ...
            className="flex w-[clamp(25vw,100vw,30.8vw)] items-center justify-end will-change-transform"
          >
            <motion.button
            ...
            >
              <div className="ml-[2.05vw] inline-block md:ml-[0.71vw]">
                <div className="group relative flex aspect-square h-[clamp(10px,10.26vw,55px)] w-[clamp(10px,10.26vw,55px)] cursor-pointer items-center justify-center overflow-hidden rounded-full md:h-[2.38vw] md:w-[2.38vw]">
                  {!visible && (
                    <PlusIcon className="z-10 size-14 scale-[1.1] stroke-1 text-white duration-300 ease-in-out group-hover:scale-50" />
                  )}

                  {visible && (
                    <X className="z-10 size-14 scale-100 stroke-1 text-white duration-300 ease-in-out group-hover:scale-50" />
                  )}

                  <motion.span
                    className={cn(
                      "glass grass absolute inset-0 top-0 aspect-square h-full w-full scale-0 rounded-full bg-white duration-500 ease-in-out group-hover:scale-100",
                    )}
                  />
                </div>
              </div>
      ...
      <AnimatePresence>
        {visible && (
          <motion.div
            ...
            className="glass fixed left-[10px] right-[10px] top-[10px] z-[99999] h-[calc(100dvh-20px)] w-[calc(100vw-20px)] origin-top-right overflow-hidden rounded-[clamp(22px,2vw,48px)] text-white shadow-2xl will-change-transform md:left-auto md:w-[clamp(25vw,100vw,20.6vw)]"
          >
            <div className="flex h-full flex-col justify-between pb-[8.21vw] pl-[6.15vw] pr-[6.15vw] pt-[88px] md:pb-[2.38vw] md:pl-[2.8vw] md:pr-[1.67vw] md:pt-[calc(16px+4vw)]">
              <nav className="mb-24 font-title md:mb-10">
...
export function Socials({ ...props }: React.HTMLAttributes<HTMLElement>) {
  ...
  return (
    <div className="flex items-center gap-4">
      ...
      {/* YouTube */}
      <Link
        href="https://youtube.com/shorts/1u8_9UBj6R4?si=enuujSSXVXeSKhur"
        target="_blank"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
